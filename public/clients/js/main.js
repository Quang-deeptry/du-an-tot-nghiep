!(function (e) {
    ...
    n.length &&
        ...
        e(document).on("click", "#top-search-form .search-button", function (
            a
        ) {
            return (
                a.preventDefault(),
        ...
        e("nav#dropdown").meanmenu({
            siteLogo:
                "<div class='mobile-menu-nav-back'><a href='index.html' class='logo-mobile'><img src='clients/img/logo.png'/></a></div>",
        }),
        new WOW().init(),
        e.scrollUp({
        ...
        e("#wrapper").on("click", "#side-menu-trigger a.menu-bar", function (
            a
        ) {
            a.preventDefault();
            var t = e(this),
            ...
            return (
                ...
                (document.getElementById("offcanvas-body-wrapper").style.right =
                    "0"),
                !1
            );
        }),
        e("#wrapper").on("click", "#side-menu-trigger a.menu-times", function (
            a
        ) {
            a.preventDefault();
            var t = e(this);
