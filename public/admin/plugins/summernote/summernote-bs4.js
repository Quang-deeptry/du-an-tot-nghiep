                ...
                function pointToTextRange(point) {
                    var textRangeInfo = function textRangeInfo(
                        ...
                        if (dom.isText(container)) {
                            ...
                            var prevContainer = lists.last(prevTextNodes)
                                .previousSibling;
                            ...
                            },
                            {
                                ...
                                value: function expand(pred) {
                                    ...
                                    if (endAncestor) {
                                        ...
                                        boundaryPoints.eo = dom.nodeLength(
                                            endAncestor
                                        );
                                    }
                        ...
                        Bullet_createClass(Bullet, [
                                    ...
                                    external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.each(
                                        ...
                                        function (idx, paras) {
                                            ...
                                            if (
                                                ...
                                                paras.map(function (para) {
                                                    var newList = _this4.findNextSiblings(
                                                        para
                                                    );
                                            ...
                                            releasedParas = releasedParas.concat(
                                                paras
                                            );
                                        }
                                    );
                            ...
                            },
                            {
                                ...
                                value: function findList(node) {
                                    return node
                                        ? lists.find(node.children, function (
                                              child
                                          ) {
                                              return (
                                                  ["OL", "UL"].indexOf(
                        ...
                        Table_createClass(Table, [
                            ...
                            },
                            {
                                ...
                                value: function addRow(rng, position) {
                                    ...
                                    var trAttributes = this.recoverAttributes(
                                        currentTr
                                    );
                        ...
                        function Editor(context) {
                            ...
                            this.createLink = this.wrapCommand(function (
                                ...
                                if (_this.options.onCreateLink) {
                                    linkUrl = _this.options.onCreateLink(
                                        linkUrl
                                    );
                                        ...
                                        .on("keydown", function (event) {
                                            ...
                                            if (!event.isDefaultPrevented()) {
                                                if (_this2.options.shortcuts) {
                                                    _this2.hasKeyShortCut = _this2.handleKeyMap(
                                                        event
                                                    );
                                                } else {
                            ...
                            },
                            {
                                ...
                                value: function pasteByEvent(event) {
                                    ...
                                    if (
                                        ...
                                        // for IE
                                        var text = window.clipboardData.getData(
                                            "text"
                                        );
                                            ...
                                            if (
                                                ...
                                                external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.each(
                                                    ...
                                                    function (idx, type) {
                                                        ...
                                                        var content = dataTransfer.getData(
                                                            type
                                                        );
                        ...
                        Codeview_createClass(CodeView, [
                            ...
                            },
                            {
                                ...
                                value: function deactivate() {
                                    ...
                                    if (env.hasCodeMirror) {
                                        var cmEditor = this.$codable.data(
                                            "cmEditor"
                                        );
                        ...
                        AutoReplace_createClass(AutoReplace, [
                            ...
                            },
                            {
                                ...
                                value: function replace() {
                                    ...
                                    this.options.match(keyword, function (
                                        match
                                    ) {
                                        if (match) {
                                            var node = "";
                        ...
                        Buttons_createClass(Buttons, [
                            {
                                ...
                                value: function representShortcut(
                                    ...
                                    var shortcut = this.invertedKeyMap[
                                        editorMethod
                                    ];
                            ...
                            },
                            {
                                ...
                                value: function addToolbarButtons() {
                                    ...
                                    for (
                                        var styleIdx = 0,
                                            styleLen = this.options.styleTags
                                                .length;
                                        styleIdx < styleLen;
                                        styleIdx++
                                    ) {
                        ...
                        Toolbar_createClass(Toolbar, [
                            ...
                            },
                            {
                                ...
                                value: function followScroll() {
                                    ...
                                    var editorOffsetTop = this.$editor.offset()
                                        .top;
                        ...
                        LinkDialog_createClass(LinkDialog, [
                            ...
                            },
                            {
                                ...
                                value: function showLinkDialog(linkInfo) {
                                    ...
                                    return external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a
                                        .Deferred(function (deferred) {
                                            var $linkText = _this.$dialog.find(
                                                ".note-link-text"
                                            );

                                            var $linkUrl = _this.$dialog.find(
                                                ".note-link-url"
                                            );

                                            var $linkBtn = _this.$dialog.find(
                                                ".note-link-btn"
                                            );
                            ...
                            },
                            {
                                ...
                                value: function show() {
                                    ...
                                    var linkInfo = this.context.invoke(
                                        "editor.getLinkInfo"
                                    );
                                ...
                                value: function update() {
                                    ...
                                    if (rng.isCollapsed() && rng.isOnAnchor()) {
                                        ...
                                        this.$popover
                                            ...
                                            .attr("href", href)
                                            .text(href);
                                        var pos = dom.posFromPlaceholder(
                                            anchor
                                        );
                            ...
                            },
                            {
                                ...
                                value: function showImageDialog() {
                                    ...
                                    return external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.Deferred(
                                        function (deferred) {
                                            var $imageInput = _this2.$dialog.find(
                                                ".note-image-input"
                                            );

                                            var $imageUrl = _this2.$dialog.find(
                                                ".note-image-url"
                                            );

                                            var $imageBtn = _this2.$dialog.find(
                                                ".note-image-btn"
                                            );
                        ...
                        VideoDialog_createClass(VideoDialog, [
                                ...
                                value: function createVideoNode(url) {
                                    ...
                                    if (ytMatch && ytMatch[1].length === 11) {
                                        ...
                                        if (typeof ytMatch[2] !== "undefined") {
                                            var ytMatchForStart = ytMatch[2].match(
                                                ytRegExpForStart
                                            );
                                ...
                                value: function show() {
                                    ...
                                    this.showVideoDialog(text)
                                        .then(function (url) {
                                            ...
                                            var $node = _this.createVideoNode(
                                                url
                                            );
                            ...
                            },
                            {
                                ...
                                value: function showVideoDialog /* text */() {
                                    ...
                                    return external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.Deferred(
                                        function (deferred) {
                                            var $videoUrl = _this2.$dialog.find(
                                                ".note-video-url"
                                            );

                                            var $videoBtn = _this2.$dialog.find(
                                                ".note-video-btn"
                                            );
                ...
                var AirPopover_AirPopover =
                    ...
                    (function () {
                        function AirPopover(context) {
                            ...
                            this.pageY = null;
                            this.events = {
                                "summernote.contextmenu": function summernoteContextmenu(
                                    e
                                ) {
                        ...
                        HintPopover_createClass(HintPopover, [
                            ...
                            },
                            {
                                ...
                                value: function createGroup(idx, keyword) {
                                    ...
                                    this.searchKeyword(idx, keyword, function (
                                        items
                                    ) {
                                        items = items || [];
                                ...
                                value: function handleKeyup(e) {
                                    ...
                                    if (
                                        ...
                                        if (this.options.hintMode === "words") {
                                            wordRange = _range.getWordsRange(
                                                _range
                                            );
                                            keyword = wordRange.toString();
                                            this.hints.forEach(function (hint) {
                                                if (hint.match.test(keyword)) {
                                                    wordRange = _range.getWordsMatchRange(
                                                        hint.match
                                                    );
                                                    return false;
                                                }
